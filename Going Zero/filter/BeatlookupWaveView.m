...
- (void)drawRect:(NSRect)dirtyRect {
    ...
    if ([_beatLookup state] == BL_STATE_STORING || [_beatLookup state] == BL_STATE_INLIVE || [_beatLookup state] == BL_STATE_PITCHSHIFTING || [_beatLookup state] == BL_STATE_TIMESTRETCHING){
